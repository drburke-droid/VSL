...
- Resize under 700 px: the handheld must appear with README.TXT on top and all the icons (13 on index.html, 17 on home.html); its screen is `left:38 top:34 250×457` in a 328×613 scene — do not move it.
