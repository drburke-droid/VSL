...
- `home.html` + `js/home.json`: the homepage version. Six archived pages chosen for clean
  Wayback rendering (Google Dec 1998, Yahoo and eBay Jan 1999, NASA Jan 1999, Hamster Dance
  2000, CNN Aug 2000), our own 1998 site re-created in `sites/cvc1998/` (period HTML, our own
  animated GIFs generated by script), and the live 2026 site, all in the same chrome, with a
  "1998 was fun, it is 2026" popup that shows once per visit and no idle screensaver. Both share css/style.css and js/app.js;
...
js/home.json                the 8 programs for home.html
