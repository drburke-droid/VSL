...
- `home.html` + `js/home.json`: the homepage version, framed as "we opened in 1998, so here
  ...
  (period HTML, our own animated GIFs generated by script), the live 2026 site, and a 360°
  Momento360 tour of today's clinic (the README's Start button opens it via `data-run`), with a
