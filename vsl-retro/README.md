...
- `home.html` + `js/home.json`: the homepage version, framed as "we opened in 1998, so here
  is the web as it was that year". Fourteen archived pages, every one captured in 1998 (any other
  year ruins the joke), each checked by hand for a clean Wayback render: Google, AltaVista, Netscape,
  Apple, Winamp, Nasdaq, CNN/SI NHL and NFL standings, NHL.com, ESPN SportsZone, NBA.com, MLB
  (Sept 1998), Calgary Herald and BBC News. Amazon.com is a screenshot from May 5, 1998
  (`sites/amazon1998/`), standing in for a capture; its links do not click. Links with a short timestamp (`19981201if_`) let Wayback
  jump to the nearest capture, which was confirmed to be 1998. Plus our own 1998 site re-created in `sites/cvc1998/`
