...
- `home.html` + `js/home.json`: the homepage version, framed as "we opened in 1998, so here
  ...
  (Google Dec 1998; Yahoo, eBay, NASA and NBA.com Jan 1999; Nasdaq Feb 1999; CNN/SI NHL and NFL
  standings Dec 1998; Space Jam Jan 1997; CNN Aug 2000), our own 1998 site re-created in `sites/cvc1998/`
